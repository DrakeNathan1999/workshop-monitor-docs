...
const config: DocsThemeConfig = {
  ...
  editLink: {
    ...
    component: ({
      ...
      return <a href={`https://github.com/DrakeNathan1999/workshop-monitor-client/${filePath}`} className={className}>{children}</a>
    }
  },
  ...
  feedback: {
    ...
    useLink() {
      ...
      return `https://github.com/DrakeNathan1999/workshop-monitor-client/issues/new?${new URLSearchParams({
  ...
  head: function useHead() {
    ...
    return (
      <>
        ...
        <meta name="apple-mobile-web-app-title" content="Workshop Monitor" />
      </>
    )
  },
  logo: function Logo() {
  ...
  project: {
    link: 'https://github.com/DrakeNathan1999/workshop-monitor-client'
  },
  sidebar: {
    autoCollapse: true,
  ...
  useNextSeoProps() {
    return {
      titleTemplate: `%s | Workshop Monitor`
    }
  }
}
